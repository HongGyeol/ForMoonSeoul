    ...
    <div class="container-fluid bg-blue sticky-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="/index.traveldo" class="navbar-brand">
                    <img class="img-fluid" src="/resources/img/logo.png" alt="Logo" style="border-radius:0 0 50px 50px; border-style:solid; border-top-style: none; border-color: #5f5f5f;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="/index.traveldo" class="nav-item nav-link active">Home</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="/resources/img/getImage.png" alt="Image" style="width:500px; height:800px;">
                  
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="/resources/img/getImage(1).png" alt="Image" style="width:500px; height:800px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    2024 IT FOR문 Seoul</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="fw-medium" href="javascript:void(0)" style="color:#dfdfdf;">Hong Gyeol</a>
                </div>
            </div>
        </div>
    </div>
